...
define(function(require, exports, module) {
    ...
    /*  TODO: Most of the below will need to be rewritten if not replaced entirely.
        To fulfill the ticket requirement(https://github.com/emmetio/emmet/issues/442)
        a function which generates a first name, a surname, a full name and an
        email address is required. However I also want to add an additional function
        which will generate a uk and/or us phone number */
